program main
    ...
    !     tmp(i) = 0d0
    ! end do
    ! ! open (10, file="output_obs_1e4_1e3_3plane/400.csv", status='old')
...
contains
    ...
    subroutine point_cloud(fault_filepath, slip_filepath)
        ...
        integer :: ie, iparticle, idim, inode, ir1, ir2, iplane, jnode, idpoint, cnt, stride
